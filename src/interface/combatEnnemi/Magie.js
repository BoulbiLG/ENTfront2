...
const Magie = ({ etapeSet, joueurCourant, storeEnnemis, storeCombat, historique, historiqueSet, ennemiEnVie, joueurUtilisableSet, joueurUtilisable, storeJoueurs, strategieEnnemi, strategieEnnemiSet, joueurRestant }) => {
    ...
    // UTILISER UN SORT
    const utiliserSortBrut = (joueurCourant, storeCombat, storeEnnemis, sortCourant, historique, historiqueSet, avertissementSet, ennemi, ennemiEnVie, storeJoueurs, idEnnem) => {
        ...
        <div className='Magie' >
            ...
            {cible === 'true' ? (
                <div className="listeEnnemis">
                    ...
                    <br />
                    {storeEnnemis.ennemi.map((ennemi, index) => (
                        <>
                            {ennemi.vie > 0 ? (
                                ...
                                >
                                    <p>{ennemi.nom} niv°{ennemi.niveau}</p>
                                </div>
                            ) : null }
                        </>
                    ))}
