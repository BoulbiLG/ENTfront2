...
const VolutesStore = create((set) => ({
  ...
  soumis: 'non',
  status: 'normal',
  classe: "Admin impitoyable / Boss final d'Onche",
  sexe: 'h',
  ...
  dialogue: {
    ...
    dialogueNormal: {
      r1: {
        texte: "A la moindre bétises -> goulag. Te voilà prévenu.",
        sticker: 'https://image.noelshack.com/fichiers/2021/30/2/1627390028-caidgelem.png',
        index: 1},
    },
