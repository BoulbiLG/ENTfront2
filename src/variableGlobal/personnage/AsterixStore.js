...
import normal from '../../asset/personnage/asterix/normal.png';
import icone from '../../asset/personnage/asterix/icone.png';
...
const AsterixStore = create((set) => ({
  ...
  dialogue: {
    ...
    dialogueNormal: {
      r1: {
        texte: "Putain quelle France de merde",
        sticker: 'https://image.noelshack.com/fichiers/2020/52/7/1609073727-34.jpg',
        index: 1},
      r2: {
        texte: "Rempli de bogmoules de tarlouses LGBT et de yehoudim",
        sticker: 'https://image.noelshack.com/fichiers/2020/52/7/1609073727-34.jpg',
        index: 2},
      r3: {
        texte: "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAhhh",
        sticker: 'https://image.noelshack.com/fichiers/2020/52/7/1609073727-34.jpg',
        index: 3},
    },
