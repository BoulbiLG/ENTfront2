...
import normal from '../../asset/personnage/leoben/normal.png';
import icone from '../../asset/personnage/leoben/icone.png';
...
const LeobenStore = create((set) => ({
  ...
  dialogue: {
    ...
    dialogueNormal: {
      r1: {
        texte: "hihi je suis une fillEnt",
        sticker: 'https://image.noelshack.com/fichiers/2023/18/2/1683046555-jesusfemmedef1.png',
        index: 1},
    },
