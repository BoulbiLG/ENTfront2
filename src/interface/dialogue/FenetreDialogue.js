...
const FenetreDialogue = ({ storePersonnage, etatSet }) => {
    ...
    const [blondinPremierCombat, blondinPremierCombatSet] = useState('oui');
    ...
    <div
        ...
        <div className="choix">
            ...
            <div className="humeur">
                ...
                {personnageStore.nom === 'Blondin' && storeCelestin.goulagBlondin === '' && blondinPremierCombat === 'oui' && storeCelestin.piedBiche === 'fini' && personnageStore.soumis !== 'oui' ? (<button className='btnClasse dialogueJoueur blondin' onClick={() => {blondinPremierCombatSet('non'); verificationDialogue(personnageStore.nom, 99999, 'blondin', {}, dialogueAffichageSet, personnageStore, storeEquipe, storeRefresh, '', storeCelestin, storeCombat, storeMusique, etatSet);}}>Casse toi de mon chemin sale violeur de poule</button>) : null }
