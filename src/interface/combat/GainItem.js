                    ...
                    <div className="listeNomEnnemi">
                        {storeEnnemis.map((nom, index) => (
                            <div className="carteNom">
                                <p className='ennemiNom'>{storeEnnemis[index].nom}</p>
                                <p className='ennemiNom'>niveau {storeEnnemis[index].niveau}</p>
                                <img src={storeEnnemis[index].imgIcone} alt={storeEnnemis[index].imgIcone} style={{
                                    width: '50px',
                                    height: '50px'
                                }}/>
                            </div>
